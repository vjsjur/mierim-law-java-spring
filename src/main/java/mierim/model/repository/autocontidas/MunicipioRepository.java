...
public interface MunicipioRepository extends JpaRepository<Municipio, Integer> {
    ...
    @Query(" select distinct new mierim.rest.dto.MunicipioDTO(s.cod_mun, s.cod_mun_comp, s.nome_mun) from cad_municipio s where upper( s.sigla_uf ) like upper( :siglmun ) order by 1" )
