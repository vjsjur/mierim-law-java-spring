...
import mierim.model.entity.juridico.Jur_AtoPerfil;
...
public class Jur_AtoPerfilDTO    implements Serializable {
    private static final long serialVersionUID = 1L;

    protected Long id;
    protected String descricao;
    protected Jur_Ato jur_ato;
    ...
    public Jur_AtoPerfilDTO(){
        super();
    }

    public Jur_AtoPerfilDTO(Jur_AtoPerfil obj){
        this.id = obj.getId();
        this.descricao = obj.getDescricao();
        this.jur_ato = obj.getJur_ato();
