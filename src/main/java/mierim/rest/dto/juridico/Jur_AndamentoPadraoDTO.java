...
import mierim.model.entity.juridico.Jur_AndamentoPadrao;
...
public class Jur_AndamentoPadraoDTO  implements Serializable {
    ...
    public Jur_AndamentoPadraoDTO(){
        super();
    }

    public Jur_AndamentoPadraoDTO(Jur_AndamentoPadrao obj){
        this.id = obj.getId();
